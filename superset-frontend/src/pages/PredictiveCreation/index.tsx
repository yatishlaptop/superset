...
import withToasts from 'src/components/MessageToasts/withToasts';
 import {MAX_ADVISABLE_VIZ_GALLERY_WIDTH
} from 'src/explore/components/controls/VizTypeControl/VizTypeGallery';
import ModelTypeGallery from 'src/explore/components/controls/VizTypeControl/ModelTypeGallery';
...
export interface PredictiveCreationProps extends RouteComponentProps {
  user: UserWithPermissionsAndRoles;
  addSuccessToast: (arg: string) => void;
  theme: Theme;
}

export type PredictiveCreationState = {
...
export class PredictiveCreation extends PureComponent<
  PredictiveCreationProps,
  PredictiveCreationState
> {
  constructor(props: PredictiveCreationProps) {
    super(props);
    this.state = {
      vizType: null,
    ...
    return (
      <StyledContainer>
        ...
        <Steps direction="vertical" size="small">
          ...
          />
          <Steps.Step
            title={<StyledStepTitle>{t('Choose Prediction type')}</StyledStepTitle>}
        ...
        <div className="footer">
          {isButtonDisabled && (
            <span>
              {t('Please select both a Dataset and a Model type to proceed')}
            </span>
          )}
          <Button
            buttonStyle="primary"
...
export default withRouter(withToasts(withTheme(PredictiveCreation)));
